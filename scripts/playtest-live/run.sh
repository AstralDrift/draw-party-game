...
echo "  Draw   · Canvas + Submit reachable; host +30 appears if someone stalls"
echo "  Fake   · Title field stays above keyboard; after submit phone says Look up / Watch the TV"
echo "  Vote   · Letter grid only; after pick phone clears to Look up"
